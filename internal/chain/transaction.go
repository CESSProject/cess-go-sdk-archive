...
func (ci *CessInfo) UploadFileMetaInformation(fileid, filename, filehash string, ispublic bool, backups uint8, filesize, downloadfee *big.Int, WalletAddress string) (string, error) {
	var (
		err         error
		accountInfo types.AccountInfo
	)
